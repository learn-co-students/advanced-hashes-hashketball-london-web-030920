...
def players
    players_by_team = game_hash.map do |home_or_away, team_name_hash|
        team_name_hash[:players]
    end
...
def team_colors(team_name)
    game_hash.each do |home_or_away, team|
        return game_hash[home_or_away][:colors] if team[:team_name] == team_name
        end
end
...
def get_team_hash(team_name)
    found_hash = game_hash.find do |home_or_away, team_name_hash|
        team_name_hash[:team_name] == team_name
    end
    found_hash[1]
end
